      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            >
              Welcome back, <span style={{ color: 'var(--primary)', fontWeight: '600' }}>{session?.user?.name || "User"}</span>
            </p>
          </div>
          <button
        ...
        <button
          ...
          onMouseEnter={(e) => !creatingProject && (e.currentTarget.style.background = 'var(--primary-hover)')}
          onMouseLeave={(e) => !creatingProject && (e.currentTarget.style.background = 'var(--primary)')}
        >
          <FiPlus size={22} />
            ...
            {projects.map((project) => (
              <div
                ...
                onMouseLeave={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = '0 10px 15px -3px var(--shadow)';
                }}
              >
